...
key_memory('merchant_backstory_3', 'Miguel enlisted the year after Tomas died. Said he wanted a soldier\'s death rather than a sick man\'s. He got his wish. We received word in the autumn — no body, just a letter from his captain.').
